...
while True:
    ...
    pygame.draw.rect(screen, pink, player)  # Draw player paddle
    # TODO Task 1: Change color of the ball
    pygame.draw.ellipse(screen, pink, ball)  # Draw ball
    player_text = basic_font.render(f'{score}', False, pink)  # Render player score
